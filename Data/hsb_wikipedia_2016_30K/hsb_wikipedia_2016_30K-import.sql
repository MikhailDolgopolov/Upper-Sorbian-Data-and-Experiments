...
CREATE TABLE "words" (
  ...
  KEY "word" ("word"),
  KEY "w_id" ("w_id")
) ENGINE=MyISAM AUTO_INCREMENT=66552 DEFAULT CHARSET=utf8;

CREATE TABLE "sentences" (
  "s_id" int(10) unsigned NOT NULL AUTO_INCREMENT,
  "sentence" text,
  KEY "s_id" ("s_id")
) ENGINE=MyISAM AUTO_INCREMENT=30001 DEFAULT CHARSET=utf8;
...
CREATE TABLE "sources" (
  ...
  KEY "so_id" ("so_id"),
  KEY "date" ("date")
) ENGINE=MyISAM AUTO_INCREMENT=8084 DEFAULT CHARSET=utf8;
